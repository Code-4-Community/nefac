...
export default function ThirtyMinuteSkillsPage() {
    return (
        <EducationInitiativeWrapper>
            <div className="override-flex-col">
                <div className="w-full py-4 pr-10">
                    <h1 className="text-3xl font-bold text-nefacblue text-[30px] mb-6">30-Minute Skills</h1>

                    <div className="flex flex-col md:flex-row items-center gap-6 mb-10">
                        <div className=" text-[20px] leading-7">
                            <p className="mb-6 pr-10">
                                We provide reporters, watchdogs and other curious community members the knowledge they can use
                                immediately in newsgathering, data collection, storytelling and other areas of journalism and
                                First Amendment law.
                            </p>
                            <p>
                                The lessons are provided in a 30-minute format to accommodate the demanding schedules faced by many
                                working in New England newsrooms. The program is free and open to the public. Registration for each
                                lesson is required.
                            </p>
                        </div>
                        <div className="flex-shrink-0">
                            <img
                                src="/images/nefac-stopwatch.png"
                                alt="NEFAC Stopwatch"
                    ...
                    <div>
                        <h2 className="font-bold text-nefacblue text-[28px]  mb-4">Recent Classes</h2>
                        <div className="bg-[#F2F6FF] border-l-[5px] border-nefacblue pl-[75px] py-[2px]">
                            <PastRecordingDisplay recordings={mockRecordings} variant="grid" />
                        </div>
                    </div>
                    <div className="mt-8">
                        <h2 className="font-bold text-nefacblue text-[28px]">Upcoming Classes</h2>
                            <img 
                                src="/images/upcoming-class.png"
                                alt="Upcoming Class"
                                className="w-full h-[350px] object-cover object-top rounded-xl mb-4 mt-6"
                            />
                            <UpcomingEventCalendar events={mockEvents} />
                    </div>
                </div>
            </div>
        </EducationInitiativeWrapper>
